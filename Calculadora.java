...
public class Calculadora {
   public static void main(String[] args) {
      ...
      float resultado = opcion == 1? primerNumero + segundoNumero : (opcion == 2? primerNumero - segundoNumero : (opcion == 3 ? primerNumero*segundoNumero : primerNumero/segundoNumero));
